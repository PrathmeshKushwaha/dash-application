...
app.layout = html.Div([
    ...
    html.H1(
        ...
        style={'color': '#503D36', 'font-size': '24px'}
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'width':'90%','padding':'3px','font-size':'20px','text-align-last':'center'}
        )
    ]),
...
def update_output_container(stats, year):
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (year and stats=='Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=px.pie(avr_vdata,values='Automobile_Sales',names='Vehicle_Type',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(year)))

    # Total Advertisement Expenditure for each vehicle using pie chart
         # grouping data for plotting.
         # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,values='Advertising_Expenditure',names='Vehicle_Type',title='Total Advertising expenditure for each vehcile in year {}'.format(year)))
